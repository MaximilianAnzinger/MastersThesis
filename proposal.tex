...
institutions have already integrated online learning into their teaching and are exploring new possibilities. \textit{Artemis} is a \ac{LMS}
developed at and used by the \ac{CIT} at the \ac{TUM} and other universities.
...
Furthermore, instructors will be able to get insight into every students' learning paths to allow for individual feedback.
...
\begin{itemize}
        \item \textbf{Sprint I} End of May (Week 20-21)
              \begin{itemize}
                      \item Implement feature to allow instructors to delete competencies.
        ...
        \item \textbf{Sprint III} End of June (Week 24-25)
              \begin{itemize}
                      \item Implement mechanism to generate exercise groups that represent a variety of different difficulty levels.
              \end{itemize}

        \item \textbf{Sprint IV} Beginning of July (Week 26-27)
              \begin{itemize}
                      \item Create server-sided learning path generation for each student.
                      \item Implement mechanism to let instructors select the accessability of learning paths.
              \end{itemize}
        ...
        \item \textbf{Sprint V} Beginning of August (Week 28-29)
              \begin{itemize}
                      ...
                      \item Research method to evaluate students' performance.
              \end{itemize}
        ...
        \item \textbf{Sprint VII} Beginning of September (Week 32-34)
              \begin{itemize}
                      ...
                      \item Implement studen view for performance indicators in learning paths.
              \end{itemize}
\end{itemize}
